...
export const BlogData = {
  blogs: [
    ...
    {
      id: "consistent-hashing-netflix",
      slug: "consistent-hashing-netflix",
      title: "How Consistent Hashing Helps Netflix Scale User Data",
      excerpt: "Netflix manages reads and writes from millions of users at once. Learn how consistent hashing helps them distribute data across database nodes reliably and scale incrementally.",
      date: "2026-02-24",
      readTime: "6 min read",
      tags: ["System Design", "Consistent Hashing", "Scaling", "Netflix"],
      featured: true,
      author: "Vinayak Jain",
      authorLink: "",
      markdownFile: "how-consistent-hashing-helps-netflix-scale-user-data.md"
    }
  ]
}
